...
function QuestionEditor({ question, index, onUpdate, onDelete, onDuplicate }: QuestionEditorProps) {
  ...
  const handleRemoveOption = (optionIndex: number) => {
    ...
    // Si la opción eliminada era la correcta, limpiar la respuesta correcta
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 mb-4">
      ...
      {/* Toggle para múltiples respuestas (solo para multiple_choice) */}
...
export default function CreateTestPage() {
  ...
  // Crear una pregunta vacía por defecto
  ...
  const handleSaveTest = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/tests/${testId}/edit`);
    } catch (error) {
  ...
  // Definir grupos de tipos de pregunta
        ...
        <div className="flex items-center justify-between max-w-[1440px] mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              />
              <p className="text-white/60 text-sm">Agrega y personaliza tus preguntas</p>
            </div>
          </div>
