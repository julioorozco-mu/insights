...
export default function EditCertificateTemplatePage() {
  ...
  const [existingElements, setExistingElements] = useState<CertificateElement[]>([]);
  ...
  if (step === 'editor') {
    ...
    return (
      <div className="py-6">
        <h1 className="text-3xl font-bold mb-6">Editar Plantilla: {title}</h1>
        {editorBackgroundUrl ? (
          <CertificateEditor
    ...
    <div className="max-w-2xl mx-auto py-12">
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          <h1 className="text-3xl font-bold mb-6">Editar Plantilla de Certificado</h1>
          ...
          <div className="form-control mb-4">
            ...
            <label className="label">
              <span className="label-text-alt">
                {selectedFile ? 'Nueva imagen seleccionada' : 'Opcional: Selecciona una nueva imagen para reemplazar la actual'}
              </span>
            </label>
          </div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button
              ...
              disabled={!title || !backgroundPreview || uploadingImage}
            >
